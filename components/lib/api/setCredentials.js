const setCredentials = () => {
  ...
  let appKey = "vtexappkey-fraldasdipano-HPPYKW";
  let appToken =
    "BBTMZFGORWBIGKXYMWOMOGGUALYNSCAJPIVPUQZAGSREUWZKUESENQQUUZMOGTVPWRSYOIDVXOFWPBZELOTOKWWYSAVVEKTNWBIDDBVLAWHZLUFSZICSAHFAVUGONIRM";

  if (useAlerteMeAccess) {
    // SET ACCESS CREDENTIALS CREATED SPECIFICALLY FOR ALERTEMEJS
    appKey = "vtexappkey-fraldasdipano-JUXTLA";
    appToken =
